...
APP_ID = int(os.environ.get("APP_ID", "27166502"))

#Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "35b9c34a2b29b20bdae81d82e2863cec")

#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002517187425"))

#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "7012709838"))
...
FORCESUB_CHANNEL = int(os.environ.get("FORCESUB_CHANNEL", "-1002651763417"))
FORCESUB_CHANNEL2 = int(os.environ.get("FORCESUB_CHANNEL2", "-1002388129891"))
FORCESUB_CHANNEL3 = int(os.environ.get("FORCESUB_CHANNEL3", "-1002397080137"))
...
SHORTLINK_API = os.environ.get("SHORTLINK_API", "87e2fb5ea65ead6b9d624ec6f5d96911eac20e00")
...
try:
    ADMINS=[7012709838]
    for x in (os.environ.get("ADMINS", "7012709838 5119055997").split()):
        ADMINS.append(int(x))
except ValueError:
